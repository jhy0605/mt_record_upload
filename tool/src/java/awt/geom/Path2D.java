...
public abstract class Path2D implements Shape, Cloneable {
        ...
        throws java.lang.ClassNotFoundException, java.io.IOException
    {
        ...
        SharedSecrets.getJavaOISAccess().checkArray(s, byte[].class, nT);
        ...
        if (storedbl) {
            SharedSecrets.getJavaOISAccess().checkArray(s, double[].class, nC);
            ((Path2D.Double) this).doubleCoords = new double[nC];
        } else {
            SharedSecrets.getJavaOISAccess().checkArray(s, float[].class, nC);
