 ...
 * (C) Copyright IBM Corp. 1995, 2021. All Rights Reserved
 *
...
class Properties extends Hashtable<Object,Object> {
    ...
    class LineReader {
        ...
        public LineReader(Reader reader) {
            ...
            readingEBCDIC = isReadingEBCDIC(reader);
        }
        ...
        Reader reader;
        boolean readingEBCDIC = false;

        private boolean isReadingEBCDIC(Reader reader) {
            try {
                return (reader instanceof InputStreamReader) &&
                    ((" ".getBytes(((InputStreamReader)reader).getEncoding()))[0] == 0x40);
        ...
        int readLine() throws IOException {
            ...
            while (true) {
                ...
                // zOS platform: New Line should be handled like Line Feed
                if (readingEBCDIC && c == '\u0085') c = '\n';
                if (skipLF) {
                    skipLF = false;
                    if (c == '\n') {
                        continue;
