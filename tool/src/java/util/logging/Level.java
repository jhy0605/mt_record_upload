...
public class Level implements java.io.Serializable {
    ...
    static final class KnownLevel extends WeakReference<Level> {
        ...
        private void remove() {
             List<KnownLevel> removenameToLevelsList;
             List<KnownLevel> removeintToLevelsList;
             if((removenameToLevelsList = nameToLevels.get(mirroredLevel.name)) != null) {
                 removenameToLevelsList.remove(this);
             }
             if((removeintToLevelsList = intToLevels.get(mirroredLevel.value)) != null) {
                 removeintToLevelsList.remove(this);
             }
        }
