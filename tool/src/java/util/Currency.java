...
public final class Currency implements Serializable {
	...
	/* JSE-10096 -backout fix as getLocaleData is no longer present in LocaleProviderAdapter
        ...
        */
        ...
        /*if ("EURO".equals(variant) || "PREEURO".equals(variant))  {             //IBM-euro_currency_oracle_giveback
            ResourceBundle rb = LocaleProviderAdapter.forJRE().getLocaleData().getNumberFormatData(locale);         //IBM-euro_currency_oracle_giveback
