 ...
 * (C) Copyright IBM Corp. 1996, 2021. All Rights Reserved
 *
    ...
    extends InputStream implements ObjectInput, ObjectStreamConstants
{
 ...
 public Boolean run() {
    ...
    public final Object readObject()
        throws IOException, ClassNotFoundException
    {
        return readObjectImpl(null,Object.class);
    }
    ...
    private String readString() throws IOException {
        try {
            return (String) readObjectImpl(null, String.class);
    ...
    {
        return iStream.readObjectImpl(caller, Object.class);
    }
     ...
     *          found.
     */
    private Object readObjectImpl(Class caller, Class type )            
               throws ClassNotFoundException, IOException                    
    {
